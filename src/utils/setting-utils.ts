...
export function applyThemeToDocument(theme: LIGHT_DARK_MODE): void {
	...
	const commitTheme = () => {
		if (needsThemeChange) root.classList.toggle("dark", targetIsDark);
		if (needsCodeThemeUpdate) root.setAttribute("data-theme", expectedTheme);
